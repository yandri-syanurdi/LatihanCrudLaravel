...
@section('content')
		<!-- start banner Area -->
		<!-- <section class="banner-area relative tes" id="home" style="background: url('{{config('sekolah.image_banner_url')}}');"> -->
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 single-blog">
						<div class="thumb">
							<img class="img-fluid" src="{{url('storage/photos/2/'.$post->thumbnail)}}" alt="">								
						</div>
