                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <h3 class="panel-title">List Video Pelajaran</h3>
                                <!-- <div class="right">
                                    <button type="button" class="btn" data-toggle="modal" data-target="#exampleModal"><i class="lnr lnr-plus-circle"></i>  Tambah Video Pelajaran  </button>
                                </div>  -->
                            </div>
                                    ...
                                    <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$data->nama_mapel}}</td>
                                                 <td> {{ str_limit($data->deskripsi, $limit = 70 )}} </td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tambah Video Pelajaran</h5>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ URL::to('/video/create') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input name="nama" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Judul">
                        </div>
