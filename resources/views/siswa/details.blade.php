                        ...
                        <!-- PROFILE HEADER -->
                            <div class="profile-header">
                                <div class="overlay"></div>
                                    ...
                                    <img src="{{$siswa->getAvatar()}}" class="img-circle" alt="Avatar" width="300px" height="300px">
                    ...
                    <div class="profile-detail">
                        ...
                        <div class="profile-info">
                            ...
                            <ul class="list-unstyled list-justify">
                                <li>Nama Pengguna : {{$siswa->nama_depan}} {{$siswa->nama_belakang}}</li>
                                ...
                                <li>Suku   :  {{$siswa->suku}}</li>
                                <li>Alamat Pengguna   : {{$siswa->alamat}}</li>
                            </ul>
                        </div>
                        <div>
