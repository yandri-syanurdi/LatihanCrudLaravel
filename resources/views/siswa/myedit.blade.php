            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <form action="{{ URL::to('/profilsaya/'.$siswa->id.'/update') }}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input name="confirmpassword" type="password" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Confirm Password">
                        </div>
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                                 ...
                                 <div class="col-lg-4 col-md-4">
                                        ...
                                        <label>Day</label>
                                        {!!Form::selectrange('day',1,31,date('d',strtotime($siswa->tanggal_mulai)),['class'=>'form-control'])!!}
                                </div>

                                 <div class="col-lg-4 col-md-4">
                                        <!-- <label>Birth Date</label> -->
                                        <label>Month</label>
                                         {!!Form::selectMonth('month',date('m',strtotime($siswa->tanggal_mulai)),['class'=>'form-control'])!!}
                                </div>

                                 <div class="col-lg-4 col-md-4">
                                        <!-- <label>Birth Date</label> -->
                                       <label>Year</label>
                                       {!!Form::selectYear('year',1970,date('Y-d-m'),date('Y',strtotime($siswa->tanggal_mulai)),['class'=>'form-control'])!!}
                                </div>
                        </div>
                        </div>
                        </div>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input name="suku" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Suku" value="{{$siswa->suku}}">
                            <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <!-- <input type="file" name="avatar" class="form-control" value="{{$siswa->avatar}}" > -->
...
@section('content1')
        ...
        <div class="row">
            ...
            <form action="{{ URL::to('/profilsaya/'.$siswa->id.'/update') }}" method="POST">
                        {{csrf_field()}}
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nama Depan</label>
                            <input name="nama_depan" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama Depan" value="{{$siswa->nama_depan}}">
