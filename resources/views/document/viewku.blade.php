                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <h3 class="panel-title">List Document Belajar</h3>
                                <div class="right">
                                    <button type="button" class="btn" data-toggle="modal" data-target="#exampleModal"><i class="lnr lnr-plus-circle"></i>  Tambah Document Belajar  </button>
                                </div> 
                            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tambah Document Belajar</h5>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ URL::to('/document/create') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nama Document</label>
                            <input name="nama" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama Document">
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlSelect1">Pilih Kategori Document</label>
