                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <br> -->
                                 ...
                                 <form class="form-inline my-2 my-lg-0" method="GET" action="{{ URL::to('/image') }}">
                                ...
                                <h3 class="panel-title">List Image Belajar</h3>
                                <div class="right">
                                    <button type="button" class="btn" data-toggle="modal" data-target="#exampleModal"><i class="lnr lnr-plus-circle"></i>  Tambah Image Belajar  </button>
                                </div> 
                            </div>
                            <div class="panel-body">
                                <table class="table table-hover">
                                    ...
                                    <tbody> 
                                            ...
                                            <tr>
                                                <td><a href="{{ URL::to('/image/'.$data->id) }}">{{$data->nama}}</a></td>
                                                <td>{{$data->kategori}}</td>
                                                <td>{{$data->deskripsi}}</td>
                                           
                                                <td> <img src="{{url('storage/image/'.$data->image)}}" height="45px;" width="50px;">  </td>
                                                <td> <a href="{{ URL::to('/image/download/'.$data->image) }}">Download</a> </td>
                                                <td>
                                                    <a href="{{ URL::to('/image/'.$data->id) }}" class="btn btn-primary btn-sm">Show</a>
                                                    <a href="{{ URL::to('/image/'.$data->id.'/edit') }}" class="btn btn-warning btn-sm">Edit</a>
                                                    <a href="{{ URL::to('/image/'.$data->id.'/delete') }}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau dihapus ?')">Delete</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                    </tbody>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tambah Image Belajar</h5>
...
<script type="text/javascript">
    ...
    $('form').ajaxForm({
        ...
        complete: function(xhr,event, position, total, percentComplete) {
                ...
                window.location.href = "/laravel-crud/public/image";
