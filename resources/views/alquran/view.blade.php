                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <br> -->
                                  ...
                                  <form class="form-inline my-2 my-lg-0" method="GET" action="{{ URL::to('/alquran') }}">
                                ...
                                <div class="right">
                                    <button type="button" class="btn" data-toggle="modal" data-target="#exampleModal"><i class="lnr lnr-plus-circle"></i>  Tambah Data Penggalan Ayat Al-Qur'an  </button>
                                </div> 
                            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tambah Data Penggalan Ayat Al-Qur'an</h5>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ URL::to('/alquran/create') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input name="terjemahan" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Terjemahan">
                        </div>
                         ...
                         <div class="form-group">
                            ...
                            <select name="nama_surat" class="form-control" id="exampleFormControlSelect1">
                                ...
                                <option value="Al-Maidah">Al-Ma’idah</option>
                                ...
                                <option value="Asy-Syuara">Asy-Syu’ara’</option>
                                ...
                                <option value="Al-Mumin">Al-Mu’min</option>
