                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Update Penggalan Ayat Al-Qur'an</h3>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="terjemahan" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Terjemahan Ayat" value="{{$alquran->terjemahan}}">
                        </div>
                         ...
                         <div class="form-group">
                            ...
                            <select name="nama_surat" class="form-control" id="exampleFormControlSelect1">
                                ...
                                <option value="Al-Ma’idah" @if($alquran->nama_surat == 'Al-Ma’idah') selected @endif>Al-Ma’idah</option>
                                <option value="Al-An’am" @if($alquran->nama_surat == 'Al-An’am') selected @endif>Al-An’am</option>
                                <option value="Al-A’raf" @if($alquran->nama_surat == 'Al-A’raf') selected @endif>Al-A’raf</option>
                                ...
                                <option value="Ar-Ra’d" @if($alquran->nama_surat == 'Ar-Ra’d') selected @endif>Ar-Ra’d</option>
                                ...
                                <option value="Al-Mu’minun" @if($alquran->nama_surat == 'Al-Mu’minun') selected @endif>Al-Mu’minun</option>
                                ...
                                <option value="Asy-Syu’ara’" @if($alquran->nama_surat == 'Asy-Syu’ara’') selected @endif>Asy-Syu’ara’</option>
                                ...
                                <option value="Al-Mu’min" @if($alquran->nama_surat == 'Al-Mu’min') selected @endif>Al-Mu’min</option>
                                ...
                                <option value="Al-Waqi’ah" @if($alquran->nama_surat == 'Al-Waqi’ah') selected @endif>Al-Waqi’ah</option>
                                ...
                                <option value="Al-Jumu’ah" @if($alquran->nama_surat == 'Al-Jumu’ah') selected @endif>Al-Jumu’ah</option>
                                ...
                                <option value="Al-Ma’arij" @if($alquran->nama_surat == 'Al-Ma’arij') selected @endif>Al-Ma’arij</option>
                                ...
                                <option value="An-Nazi’at" @if($alquran->nama_surat == 'An-Nazi’at') selected @endif>An-Nazi’at</option>
                                ...
                                <option value="Al-A’la" @if($alquran->nama_surat == 'Al-A’la') selected @endif>Al-A’la</option>
                                ...
                                <option value="Al-Qari’ah" @if($alquran->nama_surat == 'Al-Qari’ah') selected @endif>Al-Qari’ah</option>
                                ...
                                <option value="Al-Ma’un" @if($alquran->nama_surat == 'Al-Ma’un') selected @endif>Al-Ma’un</option>
