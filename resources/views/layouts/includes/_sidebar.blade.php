				...
				<nav>
					...
					<br/>
						...
						@elseif(auth()->user()->role == 'siswa')
							<li><a href="{{ URL::to('/allpostingan') }}"   class=""><i class="lnr lnr-pencil"></i> <span>Posts</span></a></li>
						@endif
						...
						<li><a href="{{ URL::to('/video') }}" class=""><i class="lnr lnr-camera-video"></i> <span>Video</span></a></li>
						@elseif(auth()->user()->role == 'siswa')
						<li><a href="{{ URL::to('/allvideo') }}" class=""><i class="lnr lnr-camera-video"></i> <span>Video</span></a></li>
						@endif
						...
						@elseif(auth()->user()->role == 'siswa')
						<li><a href="{{ URL::to('/alldocument') }}" class=""><i class="lnr lnr-file-empty"></i> <span>Document</span></a></li>
						@endif
