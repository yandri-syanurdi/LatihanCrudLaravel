                ...
                <div class="modal-body">
                    ...
                    <form action="{{ URL::to('/postingan/create') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input name="title" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Judul">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Konten"></textarea>
                        </div>
